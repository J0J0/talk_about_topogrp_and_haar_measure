...
\item
    In den vorherigen Beispielen war das Haar-Maß immer sowohl links- als auch
    ...
    Wir definieren nun die Funktionale $I$ und $J$ auf $\contcomp(G)$ wie folgt:
    \[  I(f) \defeq \int_G \frac{f(x,y)}{x^2} \dif{\lambda^2(x,y)} 
        \qqundqq
        J(f) \defeq \int_G \frac{f(x,y)}{x}   \dif{\lambda^2(x,y)}
    \]
